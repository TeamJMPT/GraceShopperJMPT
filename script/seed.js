...
const {User, Trip, Category, Order, tripOrder} = require('../server/db/models')
...
async function seed () {
  ...
  const trips = await Promise.all([
    ...
    Trip.create({name: 'Metropolis', location: 'United States', imageUrl: '/images/e96a0108b1ae7357a1a4038ed3ebae7f.jpg',
